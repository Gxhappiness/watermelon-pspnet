...
#使用绝对路径不怕报错
img = mmcv.imread('D:/0.dive into pytorch/openmmlab/mmsegmentation/data/Watermelon87_Semantic_Seg_Mask/img_dir/val/R.jpeg')
...
label = mmcv.imread('D:/0.dive into pytorch/openmmlab/mmsegmentation/data/Watermelon87_Semantic_Seg_Mask/img_dir/val/R.jpeg')
