...
data_root = 'D:/0.dive into pytorch/openmmlab/mmsegmentation/data/Watermelon87_Semantic_Seg_Mask/'
crop_size = (256, 256)
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        'D:/0.dive into pytorch/openmmlab/mmsegmentation/data/Watermelon87_Semantic_Seg_Mask/',
        data_prefix=dict(
